...
test_dataset =\
 NDRC_Dataset(path=args.test_path, 
...
test_labels, test_pairs, test_predictions = NDRC_Test.test(model, test_dataloader, device, True, label_reversed_dict)
